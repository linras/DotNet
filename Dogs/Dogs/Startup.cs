...
namespace Dogs
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = $"Server=(localdb)\\mssqllocaldb;Database=Dogs.ConsoleApp.NewDb;Trusted_Connection=True;";
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ApplicationDbInitializer dbInitializer)
        {
            ...
            //app.UseStatusCodePagesWithReExecute("url", "?statusCode={0}");
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    ...
                    template: "{controller=Events}/{action=Soon}/{id?}");
            });
        }
    }
}
